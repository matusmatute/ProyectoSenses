...
public class Registro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConfirmarContraseña = findViewById(R.id.ConfirmarContraseñaEt);
        ...
        //Evento al boton RegistarUsuario para poder registrar en la base de datos
    ...
    private void ValidarDatos(){
        ...
        if(TextUtils.isEmpty(nombre)){
            ...
            Toast.makeText(this, "Confrime contraseña", Toast.LENGTH_SHORT).show();
    ...
    private void GuardarInformacion() {
        ...
        //Obtener la indentificacion de usuario actual
